...
DEFINE_GUID(GUID_DEVINTERFACE_SSVHID,
    0xe9915ab2, 0xe2b0, 0x4e40, 0xa7, 0x01, 0x7f, 0xb9, 0x49, 0x64, 0x54, 0x2a);
...
HID_REPORT_DESCRIPTOR       G_DefaultReportDescriptor[] = {
    0x05,0x00,          /* Usage Page (Undefined ¡æ FF00) */
    0x09,0x01,          /* Usage (1) */
    0xA1,0x01,          /* Collection (Application) */
    0x15,0x00,0x26,0xFF,0x00, /* Logical 0-255 */
    0x75,0x08,0x95,0x08,       /* 8 bytes */
    0x09,0x00,          /* Usage 0 */
    0x81,0x02,          /* Input (Data,Var,Abs) */
    0xC0
};

NTSTATUS SsvEvtDeviceAdd(WDFDRIVER Driver, PWDFDEVICE_INIT DeviceInit)
{
    UNREFERENCED_PARAMETER(Driver);
    WDFDEVICE dev;
    NTSTATUS st = WdfDeviceCreate(&DeviceInit, WDF_NO_OBJECT_ATTRIBUTES, &dev);
    if (!NT_SUCCESS(st)) return st;
    return WdfDeviceCreateDeviceInterface(dev, &GUID_DEVINTERFACE_SSVHID, NULL);
}
